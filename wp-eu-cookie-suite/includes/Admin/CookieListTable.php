...
class CookieListTable extends \WP_List_Table {
	...
	public function get_columns(): array {
		return array(
			...
			'name'        => __( 'Name', 'wp-eu-cookie-suite' ),
			'domain'      => __( 'Domain', 'wp-eu-cookie-suite' ),
			'category'    => __( 'Category', 'wp-eu-cookie-suite' ),
			'service'     => __( 'Service', 'wp-eu-cookie-suite' ),
			'duration'    => __( 'Duration', 'wp-eu-cookie-suite' ),
			'detected_at' => __( 'Detected', 'wp-eu-cookie-suite' ),
		);
	}
	...
	public function column_default( $item, $column_name ): string {
		switch ( $column_name ) {
			case 'name':
				...
				$actions = array(
					'edit'   => sprintf( '<a href="%s">%s</a>', $edit_url, __( 'Edit', 'wp-eu-cookie-suite' ) ),
					'delete' => sprintf( '<a href="%s" onclick="return confirm(\'%s\')">%s</a>', $delete_url, __( 'Are you sure?', 'wp-eu-cookie-suite' ), __( 'Delete', 'wp-eu-cookie-suite' ) ),
				);
	...
	public function extra_tablenav( $which ) {
		...
		<div class="alignleft actions">
			<select name="category" id="filter-by-category">
				<option value=""><?php esc_html_e( 'All Categories', 'wp-eu-cookie-suite' ); ?></option>
			...
			<?php submit_button( __( 'Filter', 'wp-eu-cookie-suite' ), '', 'filter_action', false, array( 'id' => 'post-query-submit' ) ); ?>
		</div>
		<?php
	}
