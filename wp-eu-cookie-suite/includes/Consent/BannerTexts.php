	...
	public static function get_defaults( string $locale = 'en' ): array {
		$defaults = array(
			'en' => array(
				...
				'manage_consent_label'          => __( 'Cookie settings', 'wp-eu-cookie-suite' ),
				'revoke_consent_label'          => __( 'Revoke cookie consent', 'wp-eu-cookie-suite' ),
			...
			'de' => array(
				...
				'manage_consent_label'          => __( 'Cookie-Einstellungen', 'wp-eu-cookie-suite' ),
				'revoke_consent_label'          => __( 'Cookie-Einwilligung widerrufen', 'wp-eu-cookie-suite' ),
