...
final class ConsentLogTable extends \WP_List_Table {
	...
	public function get_columns(): array {
		return array(
			'created_at'      => __( 'Date', 'eu-cookie-consent-suite' ),
			'event_type'      => __( 'Event', 'eu-cookie-consent-suite' ),
			'categories'      => __( 'Categories', 'eu-cookie-consent-suite' ),
			'locale'          => __( 'Locale', 'eu-cookie-consent-suite' ),
			'page_url'        => __( 'Page URL', 'eu-cookie-consent-suite' ),
			'consent_uuid'    => __( 'Visitor ID', 'eu-cookie-consent-suite' ),
			'ip_hash'         => __( 'IP Hash', 'eu-cookie-consent-suite' ),
			'banner_revision' => __( 'Revision', 'eu-cookie-consent-suite' ),
		);
	}
			...
			case 'created_at':
				$actions = array(
					'snapshot' => sprintf(
						...
						__( 'Download Snapshot', 'eu-cookie-consent-suite' )
					),
				);
	...
	protected function extra_tablenav( $which ) {
		...
		<div class="alignleft actions">
			<select name="event_type">
				<option value=""><?php esc_html_e( 'All Events', 'eu-cookie-consent-suite' ); ?></option>
			...
			<?php submit_button( __( 'Filter', 'eu-cookie-consent-suite' ), 'button', 'filter_action', false ); ?>
			<a href="<?php echo esc_url( wp_nonce_url( add_query_arg( $export_args, admin_url( 'admin.php' ) ), 'wpeu_cs_export_logs_csv' ) ); ?>" class="button secondary"><?php esc_html_e( 'Export CSV', 'eu-cookie-consent-suite' ); ?></a>
		</div>
		<?php
	}
}
