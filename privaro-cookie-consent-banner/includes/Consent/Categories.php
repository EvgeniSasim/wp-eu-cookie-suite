	...
	public static function get_builtin(): array {
		return array(
			self::NECESSARY   => array(
				'label'           => __( 'Strictly Necessary', 'privaro-cookie-consent-banner' ),
				'description'     => __( 'These cookies are essential for the website to function properly.', 'privaro-cookie-consent-banner' ),
				'enabled'         => true,
				'read_only'       => true,
				'custom'          => false,
			...
			self::PREFERENCES => array(
				'label'           => __( 'Preferences', 'privaro-cookie-consent-banner' ),
				'description'     => __( 'These cookies allow the website to remember choices you make.', 'privaro-cookie-consent-banner' ),
				'enabled'         => false,
				'read_only'       => false,
				'custom'          => false,
			...
			self::STATISTICS  => array(
				'label'           => __( 'Statistics', 'privaro-cookie-consent-banner' ),
				'description'     => __( 'These cookies help us understand how visitors interact with the website.', 'privaro-cookie-consent-banner' ),
				'enabled'         => false,
				'read_only'       => false,
				'custom'          => false,
			...
			self::MARKETING   => array(
				'label'           => __( 'Marketing', 'privaro-cookie-consent-banner' ),
				'description'     => __( 'These cookies are used to track visitors across websites to display relevant ads.', 'privaro-cookie-consent-banner' ),
				'enabled'         => false,
				'read_only'       => false,
				'custom'          => false,
