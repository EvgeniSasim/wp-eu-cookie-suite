...
= 1.2.0 =
* Add support for WordPress Multisite (Network-wide settings and site-level overrides).
* Optimize settings retrieval logic with a new repository class.
* Update admin UI with network-level configuration options.
